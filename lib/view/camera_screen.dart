...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Future<void> initializeCamera() async {
    ...
    cameraController = CameraController(frontCamera, ResolutionPreset.ultraHigh,
        enableAudio: false);
  ...
  Future<void> _uploadImage() async {
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('Failed to verify face'), backgroundColor: Colors.red));

      print(
          'Failed to login: ${response.reasonPhrase} and status code: ${response.statusCode}');
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              if (isInitialized && _imageFile == null)
                AspectRatio(
                    aspectRatio: 3 / 4,
