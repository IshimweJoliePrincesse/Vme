        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Ishimwe Jolie Princesse built the ELECTA app as a study project. This service is provided at no cost and is intended for use as is. This page is used to inform visitors regarding our policies with the use and disclosure pf personal information if anyone decided to use my service. If you choose to use my service, then you agree to the collection and use of information in relation to this policy. The personal information that I collect is used for providing and improving the service. I will not use or share your information with anyone except as described in this provacy policy. The terms used in this privacy policy have the same meaning as in our terms and conditions, which are accessible at electa unless otherwise defined in this Privacy Policy ", textAlign: TextAlign.justify, style: TextStyle(fontSize: 16, fontWeight:FontWeight.w400),),
              SizedBox(height :8),
              Text("Information Collection and Use", style:TextStyle(fontSize:24, fontWeight: FontWeight.w600),),
              Text("For a better experience, while using our service, I may require you to provide us with certain personally identifiable information. The information that I request will be retained on your devide and is not collected by me in any way.", textAlign: TextAlign.justify, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400))
              SizedBox(height : 8),
              ...
              Text("We may update our privavy policy from time to time.Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new privacy policy on this page", textAlign: TextAlign.justify, style: TextStyle(fontSize:16, fontWeight: FontWeight.w400),),
              SizedBox(height:8),
