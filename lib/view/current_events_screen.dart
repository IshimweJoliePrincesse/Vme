...
class _CurrentEventsScreenState extends State<CurrentEventsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: customAppBar(
          title: AppLocalizations.of(context)!.ongoing_events,
          context: context),
      body: SafeArea(
        child: Padding(
                                          ...
                                          Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                  builder: (context) => ElectionScreen(
                                                      ...
                                                      candidates: election.candidates as List<Candidates>)));
                                        },
                                        child: Container(
                                          width: double.infinity,
                                          decoration: BoxDecoration(
                                          ...
                                          child: Center(
                                            child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    ...
                                                    color: primaryColor),
                                                child: Lottie.asset(
                                                    'assets/animations/animation_arrow.json',
                                                    height: 260,
                                                    fit: BoxFit.fill,
                                                    width: 300,
                                                    repeat: true,
